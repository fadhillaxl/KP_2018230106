        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  <?php
                  $id = $_GET['id'];
                  $sql = "SELECT * FROM suplier WHERE id_suplier = '$id'";
                  ...
                  ?>  
                    ...
                    <div class="card-header py-3">
                        ...
                        <form class="user" action="function/simpansuplier.php" method="POST">
                                <table class="table " id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                        <input type="text" readonly class="form-control" value="<?php echo $id; ?>" name="id_suplier">
                                        </td>
                                    </tr>
